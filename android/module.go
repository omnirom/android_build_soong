...
func (m *ModuleBase) Platform() bool {
	return !m.DeviceSpecific() && !m.SocSpecific() && !m.ProductSpecific() && !a.ProductOverlaySpecific() && !m.SystemExtSpecific()
}
...
func determineModuleKind(m *ModuleBase, ctx blueprint.EarlyModuleContext) moduleKind {
	...
	if (productSpecifici || productOverlaySpecific) && systemExtSpecific {
